...
const ChangePassword = () => {
    ...
    const handleEmailVerification = async (event) => {
        ...
        const url = `${process.env.REACT_APP_BACKEND_SERVER}/clientes/val_correo_cliente?email=${email}`;
        const method = 'GET';
    ...
    const handleChangePassword = async (event) => {
        ...
        const url = `${process.env.REACT_APP_BACKEND_SERVER}/clientes/cambio_pass`;
        const method = 'POST';
        const body = formData;
